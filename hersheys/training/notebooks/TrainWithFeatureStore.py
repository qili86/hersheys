...
# ``hersheys/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "model_name", "dev.hersheys.hersheys-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.hersheys.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.hersheys.trip_dropoff_features",
