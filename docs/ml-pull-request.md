...
Opening a pull request will trigger a[workflow](../.github/workflows/hersheys-run-tests.yml) 
...
Links:
* [Staging model in UC](https://uc-demo.cloud.databricks.com/explore/data/models/staging/hersheys/hersheys-model)
* [Prod model in UC](https://uc-demo.cloud.databricks.com/explore/data/models/prod/hersheys/hersheys-model)
. 
