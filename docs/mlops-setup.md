...
git add README.md docs .gitignore hersheys/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [prod workspace admin console](https://uc-demo.cloud.databricks.com#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[hersheys/databricks.yml](../hersheys/databricks.yml) file.
...
Follow the instructions in [hersheys/resources/README.md](../hersheys/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../hersheys/resources/README.md)  to propose, test, and deploy
